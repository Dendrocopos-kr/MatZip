...
public class RestaurantDAO {
	...
	public List<RestaurantRecommendMenuVO> selRestRecMenuList(RestaurantVO param) {
		List<RestaurantRecommendMenuVO> list = new ArrayList();
		String sql = " SELECT i_rest,seq, menu_nm, menu_pic, menu_price FROM t_restaurant_recommend_menu where i_rest =? ";
		JdbcTemplate.executeQuery(sql, new JdbcSelectInterface() {
			@Override
			public void prepared(PreparedStatement ps) throws SQLException {
